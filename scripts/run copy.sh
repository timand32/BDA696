...
then
    ...
    mysql -uroot -ppassword --host="mariadb" -P3306 --protocol=TCP baseball < /scripts/sql/base_runs.sql
    echo "...create defense independent pitching stats..."
    mysql -uroot -ppassword --host="mariadb" -P3306 --protocol=TCP baseball < /scripts/sql/dips.sql
